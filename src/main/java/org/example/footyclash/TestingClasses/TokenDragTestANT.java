...
public class TokenDragTestANT extends GameApplication {
    ...
    // Engine damping removed, custom fluid drag added
    private static final double CUSTOM_DRAG_COEF = 0.05;
    ...
    private void createToken(double x, double y, Color color, EntityType type) {
        ...
        physics.setOnPhysicsInitialized(() -> {
            // Disabled Engine Linear Damping to allow custom Drag Formula
    ...
    protected void onUpdate(double tpf) {
        ...
        // --- CUSTOM QUADRATIC DRAG IMPLEMENTATION ---
        getGameWorld().getEntitiesByType(EntityType.TEAM_BLUE, EntityType.TEAM_RED, EntityType.BALL)
                .forEach(entity -> {
                    ...
                    if (speedSquare > 0.1) {
                        // F = Cd * v^2
                        double dragMagnitude = CUSTOM_DRAG_COEF * speedSquare;
